...
const FeedbackCard: React.FC<FeedbackCardProp> = ({ index, testimonial, name, designation, company, image }) => {
    ...
    return (
        ...
        >
            <p className="text-#f9f9f9 font-black text-[48px]">"</p>

            <div className="mt-1">
                <p
                    className={
                        isMobile ? 'text-#f9f9f9 tracking-wider text-[14px]' : 'text-#f9f9f9 tracking-wider text-[18px]'
                    }
                >
                    {testimonial}
                </p>
                ...
                <div className="mt-7 flex justify-between padding-top-10 items-center gap-1">
                    <div className="flex-1 flex flex-col">
                        <p className="text-#f9f9f9 font-medium text-[16px]">
                    ...
                    <ClickableComponent
                        ...
                        component={() => (
                            <img src={image} alt={`feedback-by-${name}`} className="w-[65px] h-[65px] rounded-full" />
                        )}
                    />
                </div>
            </div>
